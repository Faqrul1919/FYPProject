...
class StudentFavoriteInformationScreen extends StatefulWidget {
  final Student_Favourite? itemInfo;

  StudentFavoriteInformationScreen({
    this.itemInfo,
  });

  @override
  State<StudentFavoriteInformationScreen> createState() =>
      _StudentFavouriteReview();
}

class _StudentFavouriteReview extends State<StudentFavoriteInformationScreen> {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                "Have you completed your group assignment with your team mate? \n If so please rate them on how great their team effort! ",
                textAlign: TextAlign.center,
                style: const TextStyle(
                  fontSize: 14,
                  color: Colors.black,
            ...
            Center(
              child: RaisedButton(
                onPressed: () {
                  Get.to(StudentRatingaAunthScreen(ratestud: widget.itemInfo));
                },
